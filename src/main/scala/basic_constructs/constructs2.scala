...
// ***************************************************************
 ...
 // **************************************************************
  ...
  // Match Expressions - more
  println(    MatchExpressions.matchExpression(1) )
  println(    MatchExpressions.matchExpression(1::2::3::Nil))
  println(    MatchExpressions.matchExpression(3::4::5::Nil))
...
object MatchExpressions{
  def matchExpression(toMatch:Any):String={
    toMatch match{
      case 1 => "This is 1"
      case 1::rest => s"List begins with $toMatch and rest is $rest"
      case 3::4::5::Nil => "Matched fully $toMatch"
      case _:List[_] => "Any kind of list" // it expects list of any type
    }
  }

  def matchExpression2(toMatch:Int):String={
    toMatch match{
      case 1 => "This is 1"
      case 2 => s"List begins with 2"
      case anyValue if(anyValue >2&& anyValue <4) => s"It will work only for 3 and 4  i.e $anyValue"
      // we can put conditions as well with case
    }
  }
}
